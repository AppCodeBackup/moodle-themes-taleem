 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_taleem_core_renderer extends theme_boost\output\core_renderer {
    ...
    public function earlier_user_menu() {
        ...
        data-toggle="dropdown" href="#">'.$uname.'<i class="fa fa-chevron-down">
        </i><span class="caretup"></span></a><ul class="dropdown-menu"><li>
        <a href="'.$dlink.'">'.$dashboard.'</a></li>
        <li><a href="'.$plink.'">'.$profile.'</a></li><li>
        <a href="'.$lo.'">'.$logout.'</a></li></ul></li>';
