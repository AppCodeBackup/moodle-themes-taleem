...
function slideshow() {
    ...
    $numberofslides = theme_taleem_get_setting('numberofslides');
    ...
    if ($numberofslides) {
        ...
        for ($s1 = 1; $s1 <= $numberofslides; $s1++):
            $clstxt2 = ($s1 == "1") ? ' active' : '';
            $slidecaption = theme_taleem_get_setting('slide'.$s1.'caption', true);
            $slidecaption = theme_taleem_lang($slidecaption);
            $slideimg = theme_taleem_render_slideimg($s1, 'slide' . $s1 . 'image');
            $slidebtn = theme_taleem_get_setting('slide'.$s1.'urltext');
            $slidebtn = theme_taleem_lang($slidebtn);
            $slidebtnurl = theme_taleem_get_setting('slide' . $s1 . 'url');
            $icon = "fa-angle-right";
            if (right_to_left()) {
                $icon = "fa-angle-left";
            }
